    ...
    <!-- Date Picker -->
    {{ HTML::style('backend/assets/plugins/datepicker/datepicker3.css') }}
    <!-- Daterange picker -->
    {{ HTML::style('backend/assets/plugins/daterangepicker/daterangepicker.css') }}
    <!-- bootstrap wysihtml5 - text editor -->
    {{ HTML::style('backend/assets/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css') }}
